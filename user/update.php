...
if (isset($_POST['submit'])) {
      ...
      if (isset($_POST['name']) && !empty($_POST['name'])) {
        if (preg_match('/^[A-Za-z\s]+$/', $_POST['name'])) {
          ...
          $nameerror = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>Only lowercase, uppercase, and space characters are allowed in the name field.</strong>
	  ...
	  if (isset($_POST['day']) && !empty($_POST['day'])) {
        ...
        $dayerror = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
          <strong>Please select a days.</strong>
          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>';
	...
	if (isset($_POST['blood_group']) && !empty($_POST['blood_group'])) {
        ...
        $blood_group = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
	  ...
	  if (isset($_POST['contact_no']) && !empty($_POST['contact_no'])) {
        ...
        $contact_error = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
	  ...
	  if (isset($_POST['email']) && !empty($_POST['email'])) {
		...
		if (preg_match($pattern, $_POST['email'])) {
			...
			if ($result) {
				...
				$emailerror = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
					<strong>There was an error while executing the query: ' . mysqli_error($connection) . '</strong>
					<button type="button" class="close" data-dismiss="alert" aria-label="Close">
						<span aria-hidden="true">&times;</span>
						</button>
					</div>';
	  ...
	  //insert data into database this is inseration code 
	 // Insert data into the database
if(isset($name) && isset($blood_group) && isset($gender) && isset($email) && isset($city) && isset($day) && isset($month) && isset($year) && isset($contact_no)) {

	$donordob = $year . "-" . $month . "-" . $day;
  
	$sql = "UPDATE donate SET name='$name', gender='$gender', email='$email', city='$city', dob='$donordob', contact_no='$contact_no',blood_group='$blood_group' where id=".$_SESSION['user_id'];
		...
		padding: 20px 10px 20px 30px;
			...
			<div class="row">
				...
				<div class=" card col-md-6 offset-md-3">
					...
					<!-- Error Messages -->	
<div><?php if(isset($updateerror)) echo $updateerror; ?></div>
              ...
              <select class="form-control demo-default" id="blood_group" name="blood_group" required>
                <option value=""><?php if(isset($blood_group)) echo $blood_group; ?></option>
			...
			<?php if(isset($blood_group)) echo $blood_group; ?>
			<?php if(isset($submiteerror)) echo $submiteerror; ?>
					<div class="form-group">
				...
				<div class="card col-md-6 offset-md-3">
					...
					<div class="panel panel-default" style="padding: 20px;">
						<form action="" method="post" class="form-group form-container" >
							...
							<div class="form-group">
								<button class="btn btn-lg btn-danger center-aligned" type="submit" name="delete_account" style="background-color:#880808">Delete Account</button>
							</div>
